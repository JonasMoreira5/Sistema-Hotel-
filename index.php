    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="#" class="nav-link active" aria-current="page" href="index.php">
                ...
                <li>
                    <a href="#" class="nav-link text-white">
                        ...
                        <!-- <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#adjustable"/></svg> -->
                        Lista de Reservas
                    </a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown text-white" href="#" role="button" data-bs-toggle="dropdown">
                        ...
                        <!-- <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#bootstrap"/></svg> -->
                        Cliente
                    </a>
